      ...
      {open && (
        <motion.div
          ...
          <motion.div
            ref={modalRef}
            className={cn(
              "min-h-[100%] max-h-[90%] md:max-w-[55%] bg-white dark:bg-neutral-950 border border-transparent dark:border-neutral-800 md:rounded-2xl relative z-[9999] flex flex-col flex-1 overflow-hidden",
              className
            )}
            initial={{
              opacity: 0,
